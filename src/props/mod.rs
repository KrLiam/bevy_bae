...
impl Props {
    ...
    pub fn get_value(&self, name: impl Into<Estr>) -> Option<Value>
    {
    ...
    /// Extends the properties with the contents of `other`.
    pub fn extend(&mut self, other: &Props) {
        self.properties.extend(other.properties.iter());
    } 
